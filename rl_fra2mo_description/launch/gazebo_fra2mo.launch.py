...
def generate_launch_description():
    ...
    world_file = os.path.join(get_package_share_directory('rl_fra2mo_description'), "worlds", "leonardo_race_field_new.sdf")
    ...
    position = [0.0, 2.5, 0.100]  # x, y, z
    yaw = -1.5708  # Yaw in radianti (-90°)
